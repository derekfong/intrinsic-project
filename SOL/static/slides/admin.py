...
from Main.models import Course, ClassList, UploadUserList, EnrollStudent
...
## Added an action button for uploading a class of students
class ClassListAdmin(admin.ModelAdmin):
    ...
    def enroll_students(self, request, queryset):
		for obj in queryset:
			student_list = EnrollStudents.objects.get(id=obj.id)
